    ...
    <>
      { producto ? ( 
          ...
          <div>
            <button 
            type="button"
            className="bg-sky-600 flex gap-2 px-5 py-2 text-whit rounded-md font-bold uppercase shadow-md w-full"
            ...
            <button 
              type="button"
              className="bg-red-600 flex gap-2 px-5 py-2 text-whit rounded-md font-bold uppercase shadow-md w-full mt-3"
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
